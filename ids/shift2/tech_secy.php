	...
	<nav class="fh5co-nav" role="navigation">
		<div class="container">
			...
			<div class="fh5co-top-menu menu-1 text-center">
				...
				<h1 align="center"> <font color="red"> Technical Secretary</font> </h1><br><br>
					<div id="imaging">

				<img src="images/t_secy.jpg" alt="Technical Secretary pic" width="200" height="250">
				<p>
				...
				<?php
				$query="select name from Btech16 inner join Secretary where Btech16.RollNo = Secretary.RollNo and Secretary.position = 'tech_secy'";
				...
				?>
					...
					<?php
				$query="select Btech16.RollNo from Btech16 inner join Secretary where Btech16.RollNo = Secretary.RollNo and Secretary.position = 'tech_secy'";
				$result=mysqli_query($conn,$query);
				while($row=mysqli_fetch_array($result))
				{
					echo $row['RollNo'];
				...
				<br><br><br>
					...
					<?php
				$query="select Btech16.PhoneNo from Btech16 inner join Secretary where Btech16.RollNo = Secretary.RollNo and Secretary.position = 'tech_secy'";
				$result=mysqli_query($conn,$query);
				while($row=mysqli_fetch_array($result))
				{
					echo $row['PhoneNo'];
				...
				$query="select Complaint,Complaint_id,status,RollNo from Complaint where Position = 'tech_secy'";
				$result=mysqli_query($conn,$query);
				while($row=mysqli_fetch_array($result))
				{
					...
					if($row['status']==false)
					{
						...
						if(!strcmp($row['RollNo'],$_SESSION['user_id'])){
							...
							echo "<a href=\"js_login/test.php?type=tech_secy.php&id=$c_id\"> Remove compaint (done!)</a>";
