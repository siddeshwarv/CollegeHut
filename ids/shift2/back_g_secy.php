	...
	<nav class="fh5co-nav" role="navigation">
		<div class="container">
			...
			<div class="fh5co-top-menu menu-1 text-center">
				...
				<!-- <?php
				$query="select Secretary.Promise1 from Btech16 inner join Secretary where Btech16.RollNo = Secretary.RollNo and Secretary.position = 'g_secy'";
				$result=mysqli_query($conn,$query);
				while($row=mysqli_fetch_array($result))
				{

					if($row['Promise1']!=null)
					{
						?>
						<li> 
						<?php
				...
				$query="select Secretary.Promise2 from Btech16 inner join Secretary where Btech16.RollNo = Secretary.RollNo and Secretary.position = 'g_secy'";
				$result=mysqli_query($conn,$query);
				while($row=mysqli_fetch_array($result))
				{

					if($row['Promise2']!=null)
					{
						?>
						<li> 
						<?php
				...
				$query="select Secretary.Promise3 from Btech16 inner join Secretary where Btech16.RollNo = Secretary.RollNo and Secretary.position = 'g_secy'";
				$result=mysqli_query($conn,$query);
				while($row=mysqli_fetch_array($result))
				{

					if($row['Promise3']!=null)
					{
						?>
						<li> 
						<?php
				...
				$query="select Secretary.Promise4 from Btech16 inner join Secretary where Btech16.RollNo = Secretary.RollNo and Secretary.position = 'g_secy'";
				$result=mysqli_query($conn,$query);
				while($row=mysqli_fetch_array($result))
				{

					if($row['Promise4']!=null)
					{
						?>
						<li> 
						<?php
				...
				$query="select Secretary.Promise5 from Btech16 inner join Secretary where Btech16.RollNo = Secretary.RollNo and Secretary.position = 'g_secy'";
				$result=mysqli_query($conn,$query);
				while($row=mysqli_fetch_array($result))
				{

					if($row['Promise5']!=null)
					{
						?>
						<li> 
						<?php
